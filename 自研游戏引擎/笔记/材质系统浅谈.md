...
- 与纹理Texture的区别
    ...
    - 纹理是材质的一部分，就像颜色是材质的一部分
    - 纹理是一个图片
    - 纹理用来描述物体表面的样子，如木纹
    - 材质描述物体表面的细节，包括纹理、光滑度(smoothness), 粗糙度(roughness), 柔软度(softness), 金属质感
    - 材质描述物体对光的交互（反射系数、折射系数）性质。
    - 材质是一个“东西”，纹理是对某样东西的“感觉”、“视觉”
...
![](https://i-blog.csdnimg.cn/blog_migrate/7dda07c1c43309bebd8f8920136fd84b.png)
...
![请添加图片描述](https://i-blog.csdnimg.cn/blog_migrate/8e81a66c553ffb19f88cb126387fec60.png)