...
tags:
  ...
  - Premake
category: 游戏引擎
description: ImGui的引入，渲染与ImGui事件
---
---
...
ImGui（全称 Immediate Mode Graphical User Interface，**即时模式图形用户界面**），和你可能听过的传统 GUI 库（如 Qt、MFC、WinForms）完全不同，它的核心特点是 “**即时渲染、无状态、轻量级**”：
